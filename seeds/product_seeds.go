...
func GetProductSeeds() []*entities.Product {
	...
	seeds := []*entities.Product{
		&entities.Product{UUID: uuid.MustParse("2ef2e322-8b7c-4b11-8432-15d082f49f43"), ImageKey: mockHelmetImageURL, Manufacturer: "Shoei2", Model: "RF-8000", MSRPCents: 29900, Type: "helmet", Subtype: "full", SafetyPercentage: 1},
		&entities.Product{UUID: uuid.MustParse("9c7d1d1b-1c95-4d81-b6df-c6ad2445efa7"), ImageKey: mockHelmetImageURL, Manufacturer: "Shoei", Model: "RF-7000", MSRPCents: 49999, Type: "helmet", Subtype: "modular", SafetyPercentage: 2},
		&entities.Product{UUID: uuid.MustParse("1af5b06b-5f76-4df7-9908-563be1b646fe"), ImageKey: mockHelmetImageURL, Manufacturer: "Arai", Model: "Some Arai Helmet", MSRPCents: 79999, Type: "helmet", Subtype: "open", SafetyPercentage: 3},
		&entities.Product{UUID: uuid.MustParse("ffd16692-c5ac-4bad-8f99-7dab33ab96dc"), ImageKey: mockHelmetImageURL, Manufacturer: "NotAShoei", Model: "Model-RF", MSRPCents: 19999, Type: "helmet", Subtype: "half", SafetyPercentage: 4},
		&entities.Product{UUID: uuid.MustParse("8b9a42f5-0ead-49d3-b5d7-257a977cdb05"), ImageKey: mockHelmetImageURL, Manufacturer: "AGV", Model: "AyyGeeVee", MSRPCents: 29999, Type: "helmet", Subtype: "offroad", SafetyPercentage: 4},
		&entities.Product{UUID: uuid.MustParse("c486bbcf-dd73-45ea-be8a-fcef31ef956b"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer1", Model: "RF-SR1", MSRPCents: 29899, Type: "helmet", Subtype: "full", SafetyPercentage: 5},
		&entities.Product{UUID: uuid.MustParse("236fa58c-c606-4b77-b93c-2ef750feb514"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer2", Model: "RF-SR2", MSRPCents: 40012, Type: "helmet", Subtype: "modular", SafetyPercentage: 6},
		&entities.Product{UUID: uuid.MustParse("ebfa48c0-da4c-41e9-83e5-b58995282770"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer3", Model: "RF-SR", MSRPCents: 50099, Type: "helmet", Subtype: "open", SafetyPercentage: 7},
		&entities.Product{UUID: uuid.MustParse("09e88608-1156-4c25-9b01-efeede2646bd"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer4", Model: "RF-SR", MSRPCents: 60099, Type: "helmet", Subtype: "half", SafetyPercentage: 8},
		&entities.Product{UUID: uuid.MustParse("160addb2-6880-4f2e-a91c-498ce953c97c"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer5", Model: "RF-SR3", MSRPCents: 70099, Type: "helmet", Subtype: "full", SafetyPercentage: 100},
		&entities.Product{UUID: uuid.MustParse("852af68b-d103-47c3-9fe8-b4f96f896ca9"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer6", Model: "RF-SR4", MSRPCents: 79999, Type: "helmet", Subtype: "modular", SafetyPercentage: 9},
		&entities.Product{UUID: uuid.MustParse("71313790-4844-474a-abb8-a0dc051abc81"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer7", Model: "RF-SR5", MSRPCents: 80099, Type: "helmet", Subtype: "open", SafetyPercentage: 10},
		&entities.Product{UUID: uuid.MustParse("d98b4e1d-9d60-4c4d-b0c6-94a90ba4410a"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer8", Model: "RF-SR6", MSRPCents: 89999, Type: "helmet", Subtype: "half", SafetyPercentage: 11},
		&entities.Product{UUID: uuid.MustParse("d26bc29c-371d-4abd-bca2-dd1f9a31b057"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer9", Model: "RF-SR7", MSRPCents: 90099, Type: "helmet", Subtype: "full", SafetyPercentage: 12},
		&entities.Product{UUID: uuid.MustParse("5330628b-c91b-4de7-90b8-e09d05038a1c"), ImageKey: "", Manufacturer: "Manufacturer10", Model: "RF-SR8", MSRPCents: 0, Type: "helmet", Subtype: "modular", SafetyPercentage: 1},
		&entities.Product{UUID: uuid.MustParse("58c794e2-2ae2-41c9-a16d-03bab94c5229"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer11", Model: "RF-SR9", MSRPCents: 100099, Type: "helmet", Subtype: "open", SafetyPercentage: 13},
		&entities.Product{UUID: uuid.MustParse("a123f97f-3048-4716-bd73-5b8577f6e664"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer12", Model: "RF-SR10", MSRPCents: 100299, Type: "helmet", Subtype: "half", SafetyPercentage: 14},
		&entities.Product{UUID: uuid.MustParse("a51d8208-75fb-4601-9b0b-7315b03ab155"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer13", Model: "RF-SR11", MSRPCents: 110099, Type: "helmet", Subtype: "offroad", SafetyPercentage: 15},
		&entities.Product{UUID: uuid.MustParse("5341f6cb-0b6f-4400-8a59-41cd514133b3"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer14", Model: "RF-SR12", MSRPCents: 120099, Type: "helmet", Subtype: "full", SafetyPercentage: 1},
		&entities.Product{UUID: uuid.MustParse("0fc1831b-b04b-42e6-a733-797c0905d066"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer15", Model: "RF-SR13", MSRPCents: 133001, Type: "helmet", Subtype: "modular", ModelAliases: modelAliases, SafetyPercentage: 0},
		&entities.Product{UUID: uuid.MustParse("1b0b38ad-4a60-454a-b701-bb884848e139"), ImageKey: mockHelmetImageURL, Manufacturer: "Manufacturer16", Model: "RF-SR14", MSRPCents: 133002, Type: "helmet", Subtype: "full", ModelAliases: modelAliases, SafetyPercentage: 0, IsDiscontinued: true},
		&entities.Product{UUID: uuid.MustParse("5e2398ff-5a08-40bc-9eaa-4b3c3de93475"), ImageKey: mockHelmetImageURL, Manufacturer: "JacketManu1", Model: "Facturer1", MSRPCents: 59999, Type: "jacket", Subtype: "", SafetyPercentage: 1},
		&entities.Product{UUID: uuid.MustParse("1d5f5500-b64f-4ca4-81fd-a2f4bad6bc72"), ImageKey: mockHelmetImageURL, Manufacturer: "JacketManu2", Model: "Facturer2", MSRPCents: 69999, Type: "jacket", Subtype: "", SafetyPercentage: 2},
		&entities.Product{UUID: uuid.MustParse("65f61bf4-9098-4c13-b8ab-926943f6fd49"), ImageKey: mockHelmetImageURL, Manufacturer: "JacketManu3", Model: "Facturer3", MSRPCents: 79999, Type: "jacket", Subtype: "", SafetyPercentage: 3},
		emptyJacket,
	}
