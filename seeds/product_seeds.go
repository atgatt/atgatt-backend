...
func GetProductSeeds() []*entities.Product {
	...
	for i := 0; i < len(seeds); i++ {
		...
		if i%2 == 0 {
			...
			seeds[i].HelmetCertifications.SHARP.ImpactZoneRatings.Top.Front = 3
			seeds[i].HelmetCertifications.SHARP.ImpactZoneRatings.Top.Rear = 5
			seeds[i].HelmetCertifications.SNELL = true
		} else if i%3 == 0 {
			seeds[i].HelmetCertifications.ECE = true
			seeds[i].HelmetCertifications.DOT = true
			seeds[i].HelmetCertifications.SHARP = &entities.SHARPCertification{}
			...
			seeds[i].HelmetCertifications.SHARP.ImpactZoneRatings.Top.Front = 2
			seeds[i].HelmetCertifications.SHARP.ImpactZoneRatings.Top.Rear = 3
			seeds[i].HelmetCertifications.SNELL = true
		} else {
			seeds[i].HelmetCertifications.ECE = false
			seeds[i].HelmetCertifications.DOT = false
			seeds[i].HelmetCertifications.SHARP = nil
			seeds[i].HelmetCertifications.SNELL = false
